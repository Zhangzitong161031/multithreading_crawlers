...
class Spider(threading.Thread):
    ...
    def getListHtml(self,url,repeat_count=0):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                page_no = url.replace("http://588ku.com/sucai/0-default-0-0-renwubiaoqingbao-0-", "").replace("/","")
    ...
    def downloadImage(self,src,file_path,repeat_count=0):
        ...
        try:
            ...
            if repeat_count < 4:
                ...
                self.sqlInsertFailedUrl("image",src)
    ...
    def sqlInsertFailedUrl(self,url,type):
        try:
            global sql
            sql = """INSERT IGNORE INTO 588ku_failed_{}_url(url) VALUES ('{}')""".format(type,url)
...
def main():
    ...
    url_list = ["http://588ku.com/sucai/0-default-0-0-renwubiaoqingbao-0-%d/"% (index) for index in range(1, 70)]
    url_que = Queue(1000)
